...
<table width="863" border="1" bgcolor="#ABBCE9">
  ...
  <tr>
    <td width="165" height="249" valign="top"><form name="form1" method="post" action="">
      <input type="button" name="Submit" value="发短消息" onClick="window.location.href='<%=request.getContextPath() %>/WEB-INF/jsp/test.jsp';">
	  <br/>
	  <input type="button" name="Submit" value="发系统消息" onClick="window.location.href='sendsys'">
    </form>      
