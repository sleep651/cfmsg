...
<html>
  <head>
    <title>短信查询</title>
		...
		$(function() {
			$("#receiveuserid").autocomplete('${pageContext.request.contextPath}/admin/sendsms_getjson.nsf', {
				multiple: true,
				multipleSeparator:";",
				mustMatch: false,
				autoFill: false,
  ...
  <body>
	<table width="998" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td class="bg_table">
			<!-- 查询框 start -->
					<form id="sendForm" method="post" name="sendForm" action="${pageContext.request.contextPath}/admin/senddo.nsf">
					<input type="hidden" name="curUserID" value="${param.curUserID}" />
